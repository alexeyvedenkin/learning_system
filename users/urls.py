...
urlpatterns = [
    ...
    path(
        "subscriptions/", SubscriptionAPIView.as_view(), name="subscription-list"
    ),  # для создания и получения подписок
    path(
        "subscriptions/<int:course_id>/", SubscriptionAPIView.as_view(), name="subscription-detail"
